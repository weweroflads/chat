...
public class Client {
    ...
    public boolean start() {
        ...
        String msg = "Connection accepted " + this.socket.getInetAddress() + ":"
                + this.socket.getPort();
        this.display(msg);
        ...
        try {
            ...
            this.sOutput = new ObjectOutputStream(
        ...
        try {
            ...
            this.sOutput.writeObject(this.password);
        } catch (IOException eIO) {
    ...
    public static void main(String[] args) {
        ...
        switch (args.length) {
            ...
            default:
                System.out.println(
                        "Usage is: > java Client [username] [password] [portNumber] {serverAddress]");
                return;
        }
    ...
    class ListenFromServer extends Thread {
        ...
        public void run() {
            while (true) {
                try {
                    String msg = (String) Client.this.sInput.readObject();
                    // if console mode print the message and add back the prompt
                    if (Client.this.cg == null) {
                        System.out.println(msg);
                        System.out.print("> ");
                    } else {
                        Client.this.cg.append(msg);
                    }
                } catch (IOException e) {
                    Client.this
